...
public class FMEDiagramEditor extends DiagramEditor {
    ...
    public static final String DIAGRAM_EDITOR_ID = "org.eclipse.featuremodel.treeeditor.diagrameditor";
    /** the diagram type name. */
    public static final String DIAGRAM_TYPE_NAME = "Feature Diagram";
    /** the diagram type id. */
    public static final String DIAGRAM_TYPE_ID = "org.eclipse.featuremodel.treeeditor.diagramtype";
    /** the diagram type provider id. */
    public static final String DIAGRAM_TYPE_PROVIDER_ID = "org.eclipse.featuremodel.treeeditor.diagramtypeprovider";
